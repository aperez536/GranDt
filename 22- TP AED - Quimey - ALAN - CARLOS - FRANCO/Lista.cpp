...
/*------------------------------*/
void cambiarLugarDelPuntero(Lista &lista,PtrNodoLista Puntero){
    lista.primero = Puntero;
}
...
/*----------------------------------------------------------------------------*/
PtrDato getDato (Lista &lista, PtrNodoLista puntero)
{
    return (puntero->ptrDato);
}

void setDato (Lista &lista, PtrNodoLista puntero, PtrDato dato)
{
    puntero->ptrDato = dato;
}
